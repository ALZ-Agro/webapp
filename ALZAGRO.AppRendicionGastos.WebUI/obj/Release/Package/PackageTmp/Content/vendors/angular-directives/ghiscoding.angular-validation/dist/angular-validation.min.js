...
angular
     ...
     * @param string var3: [optional] friendly name
	    ...
	    function checkFormValidity(obj) {
	        ...
	        /* Begin Movizen */
	        if (obj.$error.validation) {
	            for (var i = 0, ln = obj.$error.validation.length; i < ln; i++) {
	                isValid = false;
	                elmName = obj.$error.validation[i].$name;
	                ...
	                if (!!elmName) {
	                    ...
	                    if (!!formElmObj && !!formElmObj.elm && formElmObj.elm.length > 0) {
	                        ...
	                        var msg = formElmObj.translatePromise.$$state.value;
	                        if (formElmObj.validator.params && formElmObj.validator.params.length == 1){
	                            msg = msg.replace("{0}", formElmObj.validator.params[0]);
	                        }
	                        self.commonObj.updateErrorMsg(msg, {
	                            isSubmitted: true,
